...
"use strict";
  ...
  function RulesAddController($log, $state, DeviceClass, Device, Rule, Action, Event, StateDescriptor) {
    ...
    function saveRule() {
      ...
      // ruleManager
        // .addOne(serverData.eventDescriptors, stateEvaluator, serverData.actions)
      $log.log('saveRule()');
      $log.log(serverData.eventDescriptors);
      Rule
        .add(serverData.eventDescriptors, stateEvaluator, serverData.actions)  
        .then(function(confirmation) {
          // $log.log('Rule successfully added.');
          // $log.log('Confirmation:', confirmation);
    ...
    function saveAction(actionData) {
      ...
      //   deviceId: vm.currentDevice.id,
      //   paramTypes: actionData.paramTypes
      // });
      var newAction = {

...
var copyRailsConfig = require('./config/gulp').copyRails;
...
gulp.task('clean', function() {
  return del([generalConfig.dest, copyRailsConfig.dest], {force: true});
});
...
// Rails
gulp.task('copyRails', ['copyBuild'], function() {
  return gulp.src(copyRailsConfig.src)
    .pipe(gulp.dest(copyRailsConfig.dest));
});

// Markup
gulp.task('markup', ['copyRails'], function() {
...
// Scripts
gulp.task('scripts', ['copyRails'], function() {
...
// Styles
gulp.task('styles', ['copyRails'], function() {
...
// gulp.task('dev', ['build', 'copyRails'], function() {
